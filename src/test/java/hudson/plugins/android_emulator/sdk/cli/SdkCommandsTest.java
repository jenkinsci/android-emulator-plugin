...
public class SdkCommandsTest {
    ...
    private void assertUpgradeParamsToAllToolVersions(final String expected, final String input) {
        ...
        assertEquals(Tool.SDKMANAGER, installCmdV25.getTool());
        assertEquals(Tool.ANDROID_LEGACY, installCmdV17.getTool());
        assertEquals(Tool.ANDROID_LEGACY, installCmdV04.getTool());

        assertEquals("--include_obsolete " + expected, installCmdV25.getArgs());
    ...
    public void testListInstalledComponentsCommand() {
        ...
        assertEquals(Tool.SDKMANAGER, listSdkComponentsCmdV25.getTool());
        ...
        assertEquals("--list --verbose", listSdkComponentsCmdV25.getArgs());
    ...
    public void testListExistingTargetsCommand() {
        ...
        assertEquals(Tool.AVDMANAGER, listExistingTargetsCmdV25.getTool());
    ...
    public void testListSystemImagesCommand() {
        ...
        assertEquals(Tool.SDKMANAGER, listSystemImagesCmdV25.getTool());
        ...
        assertEquals("--list --verbose", listSystemImagesCmdV25.getArgs());
    ...
    public void testIsImageForPlatformAndABIInstalledParser() {
        assertFalse(SdkCliCommandFactory.getCommandsForSdk(25)
    ...
    public void testUpdateTestProjectCommand() {
        final SdkCliCommand updateTestProjectCmdV25 = SdkCliCommandFactory.getCommandsForSdk(25).getUpdateTestProjectCommand("testProj1", null);
        ...
        assertEquals(null, updateTestProjectCmdV25.getTool());
        ...
        assertEquals("", updateTestProjectCmdV25.getArgs());
        ...
        assertTrue(updateTestProjectCmdV25.isNoopCmd());
    ...
    public void testUpdateLibProjectCommand() {
        ...
        assertEquals(null, updateLibraryProjectCmdV25.getTool());
        ...
        assertEquals("", updateLibraryProjectCmdV25.getArgs());
        ...
        assertTrue(updateLibraryProjectCmdV25.isNoopCmd());
